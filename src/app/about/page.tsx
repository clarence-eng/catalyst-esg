...
const modules = [
  ...
  },
  {
    ...
    description:
      "Post-investment engagement monitoring and pre-investment ESG due diligence. Cards view (urgency-sorted) and calendar view (chronological engagement timeline across all companies including pipeline). AI-generated 12-month ESG Action Plans with quarterly milestones. Pipeline companies shown separately.",
  },
  {
    href: "/signal",
    icon: Radio,
  ...
  return (
    <div className="p-8 max-w-4xl">
      ...
      <div className="mb-8">
        ...
        <p className="text-xs text-slate-500 mb-3">All powered by Google Gemini 2.5 Flash. Requires <code className="text-emerald-400 bg-emerald-500/10 px-1 rounded">GEMINI_API_KEY</code> in <code className="text-slate-300 bg-white/5 px-1 rounded">.env.local</code></p>
