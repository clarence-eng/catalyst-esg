      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <div>
          ...
          {filteredCaseStudies.length === 0 && (
            <p className="text-xs text-gray-500 py-4">{frameworkFilter !== "All" && q ? "No case studies match the selected category and search query." : frameworkFilter !== "All" ? "No case studies found for the selected framework category." : "No case studies match your search."}</p>
          )}
