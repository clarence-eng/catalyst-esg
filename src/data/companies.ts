  ...
  },
  {
    ...
    engagement: [
      ...
      },
      {
        ...
        status: "Completed",
        notes: "Follow-up on CTO's January 2025 commitment to procure I-RECs for 60% of Singapore DC energy by end-2025. Update received: procurement delayed to H2 2026 due to EMA certification process. Provisional I-RECs (30% of target) secured via regional broker. CTO committed to full 60% target completion by Q4 2026 via EMA scheme. Board-level awareness confirmed. Progress to be reviewed at August meeting.",
      },
      {
        date: "2026-08-20",
        type: "Meeting",
